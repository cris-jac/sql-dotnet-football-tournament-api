...
namespace Repository.Migrations
{
    ...
    [Migration("20240423214326_AddedTournaments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Entities.Match", b =>
                {
                    ...
                    b.Property<int>("PublicAttendence")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("ScoreClub1")
                        .HasColumnType("INTEGER");

                    b.Property<int>("ScoreClub2")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Model.Entities.Match", b =>
                {
                    b.HasOne("Model.Entities.Club", "Club1")
                        .WithMany()
                        .HasForeignKey("Club1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Model.Entities.Club", "Club2")
                        .WithMany()
